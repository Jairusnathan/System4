...
import { Pill, Mail, Lock, ArrowRight, AlertCircle, Loader2 } from 'lucide-react';
import { useAppContext } from '../context/AppContext';

export default function Login() {
  const { setView, setIsLoggedIn } = useAppContext();
      ...
      >
        ...
        <div className="mt-12 pt-8 border-t border-slate-100 text-center">
          <p className="text-slate-500 font-bold">
            Don't have an account? <button onClick={() => setView('register')} className="text-emerald-600 hover:text-emerald-700 transition-colors">Create Account</button>
          </p>
        </div>
      </motion.div>
    </main>
