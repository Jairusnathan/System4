...
-- Test data: 500 orders spread across 2025 Jan-Jun
-- Run in Order Supabase SQL Editor (run revert first for a clean slate)

-- Step 1: Insert 500 test transactions (2025 Jan-Jun)
...
FROM (
  SELECT
    ...
    TIMESTAMP '2025-01-01' + (RANDOM() * INTERVAL '181 days') AS created_at,
...
-- Step 2: Insert 500 test receipts (2025 Jan-Jun)
...
SELECT
  ...
  TIMESTAMP '2025-01-01' + (RANDOM() * INTERVAL '181 days'),
  true
FROM generate_series(1, 500);
...
-- Step 4: Insert ~1000 test transaction_items
...
FROM (
  SELECT
    ...
    CASE (row_number() OVER () % 37)
      WHEN 1 THEN 'Acetaminophen 500mg'
      WHEN 2 THEN 'Ibuprofen 200mg'
      WHEN 3 THEN 'Aspirin 8mg'
      WHEN 4 THEN 'Allergy Relief (Loratadine)'
      WHEN 5 THEN 'Cough Syrup'
      WHEN 6 THEN 'Antacid Tablets'
      WHEN 7 THEN 'Cold & Flu Relief'
      WHEN 8 THEN 'Multivitamin Daily'
      WHEN 9 THEN 'Vitamin D3 2000 IU'
      WHEN 10 THEN 'Vitamin C 1000mg'
      WHEN 11 THEN 'Omega-3 Fish Oil'
      WHEN 12 THEN 'Calcium + Vitamin D'
      WHEN 13 THEN 'Probiotic Complex'
      WHEN 14 THEN 'Hand Sanitizer 8oz'
      WHEN 15 THEN 'Toothpaste Whitening'
      WHEN 16 THEN 'Mouthwash Antiseptic'
      WHEN 17 THEN 'Dental Floss'
      WHEN 18 THEN 'Body Lotion 16oz'
      WHEN 19 THEN 'Sunscreen SPF 50'
      WHEN 20 THEN 'Shampoo & Conditioner'
      WHEN 21 THEN 'Adhesive Bandages (100ct)'
      WHEN 22 THEN 'Gauze Pads Sterile'
      WHEN 23 THEN 'Medical Tape'
      WHEN 24 THEN 'Antiseptic Wipes (50ct)'
      WHEN 25 THEN 'First Aid Kit'
      WHEN 26 THEN 'Thermometer Digital'
      WHEN 27 THEN 'Blood Pressure Monitor'
      WHEN 28 THEN 'Glucose Test Strips (50ct)'
      WHEN 29 THEN 'Heating Pad Electric'
      WHEN 30 THEN 'Compression Socks'
      WHEN 31 THEN 'Sleep Aid Tablets'
      WHEN 32 THEN 'Eye Drops Lubricating'
      WHEN 33 THEN 'Baby Diapers (Size 3)'
      WHEN 34 THEN 'Baby Wipes (80ct)'
      WHEN 35 THEN 'Baby Lotion 16oz'
      WHEN 36 THEN 'Baby Powder'
...
-- Step 5: Insert 500 test online_orders
...
-- Step 6: Insert ~1000 test online_order_items
...
-- Step 7: Insert 50 test return_requests
