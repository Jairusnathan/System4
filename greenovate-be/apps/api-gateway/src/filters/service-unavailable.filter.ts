...
import { ServiceUnavailableError } from '../../../../src/shared/http/request-downstream';
...
export class GatewayExceptionFilter implements ExceptionFilter {
    ...
    if (exception instanceof ServiceUnavailableError) {
      console.error(`[Gateway] Downstream unavailable — ${request.url}:`, exception.message);
    ...
    console.error(`[Gateway] Unhandled exception — ${request.url}:`, exception);
