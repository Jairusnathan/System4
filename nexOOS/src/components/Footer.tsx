      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-bold">
            ...
            <li><button onClick={() => setView('shop')} className="hover:text-blue-400 transition-colors">Shop Products</button></li>
            <li><button className="hover:text-blue-400 transition-colors">About Us</button></li>
            <li><button className="hover:text-blue-400 transition-colors">Contact Support</button></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-bold">
            ...
            <li><button className="hover:text-blue-400 transition-colors">Shipping Policy</button></li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm font-bold">
            <li className="flex items-start gap-3">
              ...
              <a href="mailto:support@pharmaquick.com" className="hover:text-blue-400 transition-colors">support@pharmaquick.com</a>
            </li>
            <li className="flex items-start gap-3">
