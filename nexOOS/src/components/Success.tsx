  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-50 py-24">
      ...
      >
        ...
        <div className="w-24 h-24 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-10 text-blue-600 shadow-xl shadow-blue-50">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button 
            ...
            className="flex-1 px-8 py-4 bg-blue-600 text-white rounded-2xl font-black text-lg hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 flex items-center justify-center gap-2 group"
          >
