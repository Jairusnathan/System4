-- seed-test-orders-500more.sql
-- Test data: 700 orders spread across 2025 Jul-Dec
-- Run in Order Supabase SQL Editor after seed-test-orders.sql

-- Step 1: Insert 700 test transactions (2025 Jul-Dec)
...
FROM (
  SELECT
    ...
    TIMESTAMP '2025-07-01' + (RANDOM() * INTERVAL '184 days') AS created_at,
...
-- Step 2: Insert 700 test receipts (2025 Jul-Dec)
...
SELECT
  ...
  TIMESTAMP '2025-07-01' + (RANDOM() * INTERVAL '184 days'),
  true
FROM generate_series(1, 700);
...
-- Step 4: Insert ~1400 test transaction_items
...
-- Step 5: Insert 700 test online_orders
...
FROM (
  ...
  ORDER BY id LIMIT 700
) t;

-- Step 6: Insert ~1400 test online_order_items
...
-- Step 7: Insert 70 test return_requests
